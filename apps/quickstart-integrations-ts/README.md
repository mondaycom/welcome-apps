...
4. Choose the "Quickstart Integration - TypeScript" template to start. Add in the missing scopes, run the command scaffold in your command line, and paste the resulting URL into the URL box.
